...
define([
    ...
    'uiLayout',
    'mage/translate'
], function (ko, $, _, utils, registry, Abstract, layout, $t) {
    'use strict';
    ...
    return Abstract.extend({
        defaults: {
            ...
            captionCustomerType: $t('Please select an option'),
            options: [],
            customerType: {
                'Natural': $t('Natural'),
                'Legal': $t('Jurídica')
            ...
            defaultOptionDocumentType: {
                'value': '',
                'label': $t('Please select a document type')
            },
            enableSelect: ko.observable(),
            customerTypeOptions: ko.observableArray([]),
        ...
        initialize: function () {
            ...
            this.setCustomerTypes(this.naturalDocumentType);
        ...
        setCustomerTypes: function () {
            let self = this;
            let customerTypeOptions = [];

            $.each(self.customerType, function (key, value) {
                customerTypeOptions.push(new self.selectOption(value, key));
            });

            self.customerTypeOptions(customerTypeOptions);
        }
    });
});
