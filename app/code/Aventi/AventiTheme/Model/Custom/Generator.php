...
namespace Aventi\AventiTheme\Model\Custom;
...
class Generator
{
    ...
    public function __construct(
        \Aventi\AventiTheme\Helper\Themeconfig $configData,
    ...
    protected function generateStoreCustomTheme($storeId)
    {
        ...
        try {
            $block = $this->_layoutManager->createBlock('Aventi\AventiTheme\Block\Customcss')->setData('area', 'frontend')->setTemplate('css/theme_option.phtml')->toHtml();
