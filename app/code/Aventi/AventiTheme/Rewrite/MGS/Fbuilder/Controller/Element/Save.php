...
namespace Aventi\AventiTheme\Rewrite\MGS\Fbuilder\Controller\Element;
...
class Save extends \MGS\Fbuilder\Controller\Element\Save
{
    ...
    public function __construct(
        ...
        CustomerSession $customerSession, Filesystem $filesystem,
        ...
        parent::__construct($context, $storeManager, $customerSession, $filesystem, $fileUploaderFactory, $file, $urlContext, $cacheManager, $request, $builderHelper);
    }
