...
namespace Aventi\SAP\Block\Adminhtml\Group\Edit;
...
class Form extends \Magento\Customer\Block\Adminhtml\Group\Edit\Form
{
    ...
    /**
     * @var \Magento\Customer\Api\GroupExcludedWebsiteRepositoryInterface
     */
    private \Magento\Customer\Api\GroupExcludedWebsiteRepositoryInterface $groupExcludedWebsiteRepository;
    ...
    protected function _prepareLayout()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'title' => __('SAP Id'),
                'class' => '',
                'note' => __('Customer group Id in sap.')
            ]
        );
        ...
        if ($this->_backendSession->getCustomerGroupData()) {
            ...
            // Do not do it without supervision and a responsible adult.
            $om = \Magento\Framework\App\ObjectManager::getInstance();
            $customerGroupModel = $om->create(\Magento\Customer\Model\Group::class);
            $customerGroupModel->load($customerGroup->getId());
            $sapId = $customerGroupModel->getData('sap');
            // End
